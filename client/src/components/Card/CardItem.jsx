    ...
    <div className='card-item-container'>
      <div className="card-item">
        ...
        <div className="card-content">
          ...
          <div className="card-details">
            <button onClick={() => navigate(`/event-page/${plan.id}`)} className='go-to-btn' type='button'>Go to event</button>
          </div>
          <div className="card-footer">
            <IconButton aria-label="delete" sx={{ "&:hover": { color: "red" } }} onClick={() => deleteEventAction(plan.id)}>
